...
<style scoped>
.auto-refresh{display:flex;align-items:center;gap:8px;color:#718594;font-size:13px}.pid-cell{display:grid;gap:3px}.pid-cell strong{color:#29485c}.pid-cell span{color:#8798a3;font-size:12px}.license-preview{display:inline-block;max-width:100%;overflow:hidden;text-overflow:ellipsis;vertical-align:bottom;white-space:nowrap}.payload-viewer{max-height:520px;margin:0;padding:18px;overflow:auto;border-radius:10px;background:#f5f8f9;color:#304c5f;line-height:1.6;white-space:pre-wrap;word-break:break-all}
</style>
