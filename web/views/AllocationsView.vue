...
<template>
  <PageHeader title="分配记录" description="查看所有成功分配的授权数据，最新分配记录优先展示。"><el-button :icon="RefreshCw" @click="load">刷新</el-button></PageHeader>
...
<style scoped>
.pid-cell{display:grid;gap:3px}.pid-cell strong{color:#29485c}.pid-cell span{color:#8798a3;font-size:12px}.payload-viewer{max-height:520px;margin:0;padding:18px;overflow:auto;border-radius:10px;background:#f5f8f9;color:#304c5f;line-height:1.6;white-space:pre-wrap;word-break:break-all}
</style>
