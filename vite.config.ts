...
const packageInfo=JSON.parse(readFileSync(fileURLToPath(new URL('./package.json',import.meta.url)),'utf8')) as {version:string}
...
export default defineConfig({
  ...
  define:{__APP_VERSION__:JSON.stringify(packageInfo.version),__BUILD_TIME__:JSON.stringify(buildTime)},
